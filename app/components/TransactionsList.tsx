...
const TransactionsList = () => {
  return (
    <div className="pt-5 ">
      <div className="text-subdued font-medium">August 17, 2023</div>
      <div className="overflow-auto mt-3 border-t border-gray-500">
        <div className="flex py-3 px-2 space-x-2 items-center border-b border-gray-500">
          <div className="basis-4/12 flex gap-x-2 items-center">
            ...
            <div>
              ...
              <p className="text-subdued ">90:25 am</p>
            </div>
          </div>
